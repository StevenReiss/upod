...
public interface Sensor extends Describable
{
...
String getCurrentState(World world);

/**
 *      Add a trigger that is called when sensor changes.
 **/

void addTrigger(SensorHandler hdlr);
...
void removeTrigger(SensorHandler hdlr);
