 ...
 *      lower priority ones that have overlapping actions.
 **/
...
/**
 *      Check if a given rule is applicable in a given world state.
 **/

boolean canBeApplied(World state);
...
boolean apply(World state) throws ConditionException, ActionException;
...
boolean applyAsync(World state,StatusHandler status) throws ConditionException;



}	// end of interface Rule
