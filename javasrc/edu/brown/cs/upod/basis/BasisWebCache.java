...
class BasisWebCache implements BasisConstants
{
...
BasisWebCache()
{
   cache_map = new ConcurrentHashMap<String,CacheItem>();
}
...
}	// end of class BasisSensorWebCache




/* end of BasisSensorWebCache.java */
