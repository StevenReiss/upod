...
/*										*/
/*	Thread pool for use in UPOD modules					*/
/*										*/
/********************************************************************************/
...
public class BasisThreadPool extends ThreadPoolExecutor
	implements BasisConstants, ThreadFactory
{
...
@Override protected void afterExecute(Runnable r,Throwable t)
{
   ...
   if (t != null) {
      System.err.println("BASIS: Problem with background task " +
	    r.getClass().getName() + " " + r + ": " + t);
      t.printStackTrace();
    }
}
