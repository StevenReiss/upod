...
private static Map<UpodWorld,BasisGoogleCalendar> the_calendars;
...
static {
   ...
   try {
      ...
      BasisLogger.logE("GOOGLECAL: Initialization problem with calendar api",t);
      t.printStackTrace();
      DATA_STORE_DIR = null;
      HTTP_TRANSPORT = null;
...
private BasisGoogleCalendar()
{
   ...
   cal_names = new ArrayList<String>();
   cal_dlm = 0;
   last_check = null;
...
private void getAllEvents(long whent) throws Exception
{
   ...
   Calendar c2 = BasisCalendarEvent.startOfDay(c1);
...
/* end of BasisGoogleCalendarApi.java */
